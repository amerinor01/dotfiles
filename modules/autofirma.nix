      ...
      policies = {
        ...
        ExtensionSettings = {
          ...
          "{446900e4-71c2-419f-a6a7-df9c091e268b}" = {
            install_url = "https://addons.mozilla.org/firefox/downloads/file/4371752/";
            installation_mode = "force_installed";
          };

          #Dont care about cookies
          "idcac-pub@guus.ninja" = {
            install_url = "https://addons.mozilla.org/firefox/downloads/file/4216095/";
            installation_mode = "force_installed";
          };
          ...
          "CookieAutoDelete@kennydo.com" = {
            install_url = "https://addons.mozilla.org/firefox/downloads/file/4040738/";
            installation_mode = "force_installed";
          };
